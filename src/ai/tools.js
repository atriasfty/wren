const TOOL_DEFS = [
  ...
  { name: 'log_punishment', description: 'Log a punishment to the POW backend. server must be "A" or "B".', params: { type: 'object', properties: { username: { type: 'string' }, type: { type: 'string', enum: ['Warn', 'Kick', 'Ban', 'Ban Bolo'] }, reason: { type: 'string' }, server: { type: 'string', enum: ['A', 'B'] } }, required: ['username', 'type', 'reason', 'server'] } },
  { name: 'check_punishments', description: 'Look up a player\'s punishment history from POW.', params: { type: 'object', properties: { username: { type: 'string' }, server: { type: 'string', enum: ['A', 'B'] } }, required: ['username'] } },
  // Discord
  ...
  { name: 'check_whitelist_status', description: 'Check if a player has the configured whitelist role.', params: { type: 'object', properties: { username: { type: 'string' } }, required: ['username'] } },
  { name: 'check_player_perks', description: 'Check a player\'s configured perk roles.', params: { type: 'object', properties: { username: { type: 'string' } }, required: ['username'] } },
