...
export async function createApiServer(client) {
  ...
  app.use((err, req, res, next) => {
    // [SECURITY-FIX] Error Handling: Catch JSON SyntaxError to prevent HTML stack traces
  ...
  app.use((err, req, res, _next) => {
    // [SECURITY-FIX] Error Handling: Catch-all handler to prevent stack trace leaks
