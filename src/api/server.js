...
export async function createApiServer(client) {
  ...
  // [SECURITY-FIX] Error Handling: Catch malformed JSON errors without leaking stack traces
  ...
  // [SECURITY-FIX] Error Handling: Global catch-all to prevent unhandled exception stack trace leaks
  app.use((err, req, res, _next) => {
