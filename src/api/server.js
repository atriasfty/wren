...
export async function createApiServer(client) {
  ...
  // [SECURITY-FIX] Configuration & Headers: disable x-powered-by completely
  ...
  // [SECURITY-FIX] Error Handling: Catch malformed JSON to prevent HTML stack trace leaks
  ...
  // [SECURITY-FIX] Error Handling: Global catch-all to prevent stack trace leaks
  app.use((err, req, res, _next) => {
