...
export async function createApiServer(client) {
  ...
  // [SECURITY-FIX] Logic & Error Handling: handle malformed JSON to prevent stack trace leaks
  ...
  // [SECURITY-FIX] Logic & Error Handling: global catch-all to prevent unhandled exceptions from leaking stack traces
