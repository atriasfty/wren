...
export async function createApiServer(client) {
  ...
  // [SECURITY-FIX] Error Handling: catch malformed JSON early to avoid HTML stack trace leaks
  ...
  // [SECURITY-FIX] Error Handling: global catch-all to prevent unhandled exceptions leaking stack traces
  app.use((err, req, res, _next) => {
