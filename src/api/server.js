...
export async function createApiServer(client) {
  ...
  // [SECURITY-FIX] Logic & Error Handling: handle JSON parse errors explicitly instead of leaking stack traces
  ...
  // [SECURITY-FIX] Logic & Error Handling: handle uncaught exceptions at the boundary
