...
const DEFAULT_POLICY = {
  ...
  purge_messages: 'mod',
  bring_all_staff: 'owner',
  pm_all_staff: 'owner',
  log_punishment: 'mod',
  save_memory_server: 'leadership',
  save_memory_user: 'user',
  delete_memory_server: 'leadership',
  delete_memory_user: 'user',
  get_vehicles: 'mod',
  get_wanted_players: 'mod',
  get_player_location: 'mod',
  get_server_briefing: 'mod',
  get_player_profile: 'mod',
...
function rowToTenant(row, encKey) {
  const t = {
    ...
    monthlyVoiceTimeSeconds: row.monthly_voice_time_seconds || 0,
